# Generated by Django 3.2.16 on 2023-04-30 06:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Снимите галочку, чтобы скрыть публикацию.', max_length=64, unique=True, verbose_name='Идентификатор')),
            ],
            options={
